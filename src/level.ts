...
export const LEVELS: Level[] = [
  ...
  // 4 — THE LONG WAY ROUND
  {
    ...
    par: 17,
    limit: 45,
    brief: 'THE LONG WAY IS THE SAFE WAY',
  },
  // 5 — TWO OF THEM
  {
    map: [
  ...
  // 7 — A BREATH
  {
    ...
    par: 10,
    limit: 30,
    brief: 'ONE HUNTER. CATCH YOUR BREATH',
  },
  ...
  // 10 — POSTED
  {
    ...
    routes: [[[9, 4], [1, 4]], [[7, 6], [7, 6]]],
    par: 15,
    limit: 40,
    brief: 'SAME FLOOR. NEW WATCH',
  },
  // 11 — PICK YOUR POISON
  {
    map: [
    ...
    par: 27,
    limit: 70,
    brief: 'FLOWERS OR GLITTER. CHOOSE',
  },
  // 12 — THE EXAMINATION
  {
    map: [
